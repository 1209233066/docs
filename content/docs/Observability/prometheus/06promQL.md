...
{{< tabpane text=true right=false >}}
  {{% tab header="**基本语法**:" disabled=true /%}}
  {{% tab header="示例格式一" lang="en" %}}
...
{{< tabpane text=true right=false >}}
  {{% tab header="**运算符**:" disabled=true /%}}
  {{% tab header="算术运算" lang="en" %}}
...
| last_over_time                     | 获取指定时间范围内最后一个非空值                             | `last_over_time(stock_price_change[60m])` |
